...
- **Ресурс управления** — внизу колонки терминала, там же, где он был до
  удаления нижней панели; список команд заканчивается над ним.
- **Решимость инженера** — в правом верхнем углу игрового поля.
  Рядом их не ставим: ресурс твой, решимость его.
